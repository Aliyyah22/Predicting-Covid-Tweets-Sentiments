...
##set team image
image = Image.open('pictures/MicrosoftTeams-image (2).jpg.png')
...
lead=Image.open('pictures/photo_2023-03-16_18-13-22.jpg')
size=(400,400)
...
lead=Image.open('pictures/WhatsApp Image 2023-09-28 at 12.19.59.jpg')
size=(400,400)
lead_image=lead.resize(size)
st.image(lead_image)
...
lead=Image.open('pictures/photo_2023-09-28_16-55-16.jpg')
size=(400,400)
lead_image=lead.resize(size)
st.image(lead_image)
...
lead=Image.open('pictures/WhatsApp Image 2023-09-28 at 19.48.07.jpg')
size=(400,400)
lead_image=lead.resize(size)
st.image(lead_image)
...
lead=Image.open('pictures/WhatsApp Image 2023-10-02 at 11.28.44.jpg')
size=(400,400)
lead_image=lead.resize(size)
st.image(lead_image)
